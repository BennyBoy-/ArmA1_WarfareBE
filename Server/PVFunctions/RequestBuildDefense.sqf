...
_script = Call Compile Format["%1DefenseScripts Select _type",Str _side];
[_type,_side,[_x,_y],_direction] Exec Format["Server\Construction\Construction_%1.sqs",_script];
